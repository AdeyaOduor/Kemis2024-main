...
const ResultsSearchPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <h2 className="text-2xl mb-4">Search Student Results</h2>
      ...
      {searchResult && (
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <div className="result-card">
            ...
            <p className="text-lg mb-2"><span className="font-semibold">Secondary School:</span> {searchResult.school_Name}</p>
            <p className="text-lg mb-2"><span className="font-semibold">KCSE MARKS:</span> {searchResult.tot}</p>
