      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="p-8 sm:p-10 lg:flex-auto">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ECDE learning programs May incorporate tree planting activities to
            educate learners of ages 5 - 6 years about the environment,
            sustainability, and the significance of trees. By engaging in play
            group activites involving caring for trees, young children can
            develop a sense of environmental responsibility, empathy towards
            nature, and an understanding of their role in preserving the planet
            for future generations. These activities can also foster a
            connection with the natural world and promote a lifelong love for
