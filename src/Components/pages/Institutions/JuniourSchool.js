export default function JuniourSchool() {
  return (
    <>
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h2 className="font-bold tracking-tight text-gray-900 lg:text-5xl">
              Juniour Secondary School (JSS)
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Junior Secondary School (JSS) serves as an educational bridge
              between primary and secondary school, providing a crucial
              transition for students who have successfully completed their
              upper primary education through a national examination. Positioned
              as a pivotal stage in the educational journey, JSS aims to foster
              academic growth, personal development, and readiness for the
              challenges of secondary education. Students entering Junior
              Secondary School embark on a transformative educational
              experience, building a solid foundation for their future academic
              pursuits.
            </p>
