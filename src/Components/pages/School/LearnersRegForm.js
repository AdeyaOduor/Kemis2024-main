...
const LearnersRegForm = () => {
  const location = useLocation();

  const [savedrecord, setSavedRecord] = useState("");
  const [upi, setUpi] = useState('');
  const [studentType, setStudentType] = useState('');
  const [assesmentNo, setAssesmentNo] = useState('');
  const [status, setStatus] = useState(false);
  const [birthCertificateNumber, setBirthCertificateNumber] = useState("");
  const [unhcrNumber, setUnhcrNumber] = useState("");
  const [unhcrRegDate, setUnhcrRegDate] = useState("");
  const [immigrationStatus, setImmigrationStatus] = useState("");
  const [studentPassNumber, setStudentPassNumber] = useState("");
  ...
  const [learnerMobile, setLearnerMobile] = useState("");
  const [motherIdentification, setMotherIdentification] = useState("");
  const [motherName, setMotherName] = useState("");
  const [motherEmail, setMotherEmail] = useState("");
  const [motherPhone, setMotherPhone] = useState("");
  const [fatherIdentification, setFatherIdentification] = useState("");
  const [fatherName, setFatherName] = useState("");
  const [fatherEmail, setFatherEmail] = useState("");
  const [fatherMobile, setFatherMobile] = useState("");
  const [gurdianIdentification, setGurdianIdentification] = useState("");
...
console.log('inputClass_Name' + inputClass_Name);
  ...
  const handleSubmit = async (e) => {
    ...
    let addLearnerurl = urlhom + `/student/api/v1/learners/addLearner`;
            ...
            <>
              ...
              {savedrecord && (
                ...
                <Alert severity="success">
                  ...
                  Student Details Have Been Saved Successfully — <strong>Check On The Learners List</strong>
                </Alert>
...
export default LearnersRegForm;
