...
const LearnersDashboard = () => {
  ...
  const cardsData = Array.from({ length: 6 }, (_, index) => ({
    id: index + 1,
  ...
  return (
    <><div style={{
      ...
      <p>Select your desired module below</p>
    </div>
    <div className="p-12 grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-2 gap-8">
