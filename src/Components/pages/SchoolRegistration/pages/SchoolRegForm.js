...
const SchoolRegForm = () => {
  ...
  const [Land_Title_Deed,setFileUploaded] = useState("");
  const [Land_Lease_Agreement, setFileUploaded2] = useState("");
  const [Land_Acreage, setLand_Acreage] = useState(0);
  const [Business_Registration_Certificate,setFileUploaded3] = useState("");
  const [Incorporation_Certificate, setFileUploaded4] = useState("");
  const [Name_Change_Certificate, setFileUploaded5] = useState("");
  ...
  const [Sub_County, setSubCountyName] = useState('');
  // const [fileuploaded, setFileUploaded] = useState('');
  // const [fileuploaded2, setFileUploaded2] = useState('');
  // const [fileuploaded3, setFileUploaded3] = useState('');
  // const [fileuploaded4, setFileUploaded4] = useState('');
  ...
  const handleRegistrationSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const registrationurl ="/schoolregapi/api/v1/Registration/getinstitutionbasic/" + Applicant_ID;
  ...
  const getWards = () => {
    const url = '/generic2/api/Cascade/Wards/' ;
    const baseurl = Homebaseurl + url;
    console.log(baseurl)
    axios
      .get(baseurl, { headers })
  ...
  const handleWardChange = (e) => {
    ...
    const option = wardlist
      .find(option => option.ward_Code === mward);
    var text = option.ward_Name;
    setWard(text);
    console.log(text, mward);
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setFileUploaded3(base64Image);
        setFileUploaded4(base64Image);
        setFileUploaded5(base64Image);
      };
    ...
    <>
      <div className="flex ">
        ...
        <div className="w-1/4 flex-row bg-gray-200 p-12 mb-4">
          ...
          <ul>
            <li
              className={`cursor-pointer border-b border-gray-300 my-8 ${currentStep === 1 && "font-bold"
                }`}
            ...
            <li
              className={`cursor-pointer border-b border-gray-300 my-8 ${currentStep === 2 && "font-bold"
                }`}
            ...
            <li
              className={`cursor-pointer border-b border-gray-300 myb-8 ${currentStep === 3 && "font-bold"
                }`}
            ...
            <li
              className={`cursor-pointer border-b border-gray-300 mb-8 ${currentStep === 4 && "font-bold"
                }`}
                  ...
                  <div className="grid md:grid-cols-2 gap-4 sm:grid-cols-1">
                    ...
                    <div className="my-2">
                      ...
                      <select
                        ...
                        {regionlist?.map((option) => (
                          <option key={option.region_Name} value={option.region_Code}>
                            {option.region_Name}
                          </option>
                        ))}
                      </select>
                    ...
                    <div className="mb-2">
                      ...
                      >
                        ...
                        {scountylist?.map((option) => (
                          <option key={option.sub_County_Name} value={option.sub_County_Code}>
                    ...
                    <div className="mb-2">
                      ...
                      >
                        ...
                        {wardlist?.map((option) => (
                          <option key={option.ward_Name} value={option.ward_Code}>
                            {option.ward_Name}
                          </option>
                    ...
                    <div className="my-2">
                      ...
                      <select
                        ...
                        <option value="boys">Day</option>
                        <option value="girls">Boarding</option>
                      </select>
