    ...
    return (
        <><div >
            <div className="mx-auto max-w-7xl py-6 sm:px-6 sm:py-12 lg:px-8 text-center">
                <div>
                    <h2 className="text-center  mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                        Why Go Digital?
                    </h2>
                </div>
                <div className="mt-12   overflow-hidden px-4 pt-16 sm:rounded-3xl sm:px-12 md:pt-24 lg:flex lg:gap-x-20 lg:px-16 lg:pt-0">
