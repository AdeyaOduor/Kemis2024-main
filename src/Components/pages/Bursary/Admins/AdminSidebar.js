...
const AdminSidebar = () => {
  ...
  const Menus = [
    { title: "Dashboard", path: "/admin", gap: "true" },
    { title: "Add Members", path: "/admin/manageusers", gap: "true" },
    { title: "Reviewed", path: "/admin/viewreviewed", gap: "big" },
    { title: "View Applicants", path: "/admin/viewapplicants", gap: "big" },
    {
      title: "Logout",
      path: "/bursaries/logout",
      icon: <FiLogOut />,
      logout: true,
    },
  ];
