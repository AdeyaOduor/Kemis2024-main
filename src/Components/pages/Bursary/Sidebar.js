...
const Sidebar = () => {
  ...
  const Menus = [
    { title: 'Dashboard', path: '/bursaries/bdasboard', icon: <AiFillPieChart />, gap: 'true' },
    { title: 'Apply', path: '/bursaries/applicationform', icon: <SiFuturelearn />, gap: 'true' },
    // { title: 'My Details', path: '/mydetails', icon: <CgProfile />, gap: 'true' },
    { title: 'Available Scholarships', path: '/bursaries/availablescholarships', icon: <SiOpenaccess />, gap: 'true' },
    //{ title: 'View My Applications', path: '/myapplications', icon: <SiOpenaccess />, gap: 'true' },
